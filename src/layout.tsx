...
export default function Layout() {
  ...
  return (
    ...
    >
      <nav className="h-[64px] bg-amber-800 border-b-4 border-amber-900 shadow-lg flex items-center justify-center gap-6 px-4 text-amber-100/80 relative z-10">
        <Link
          to={"/"}
          className={clsx(
            "transition-all duration-200 hover:text-white hover:scale-110",
            isActive("/") && `text-white scale-110 drop-shadow-md ${colors.navActive}`
          )}
        >
          <svg
        ...
        <Link
          ...
          className={clsx(
            "transition-all duration-200 hover:text-white hover:scale-110",
            isActive("/birthdays") && `text-white scale-110 drop-shadow-md ${colors.navActive}`
          )}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill={isActive("/birthdays") ? "currentColor" : "none"}
            viewBox="0 0 24 24"
            strokeWidth="2"
            stroke="currentColor"
            strokeLinecap="round"
        ...
        <Link
          ...
          className={clsx(
            "transition-all duration-200 hover:text-white hover:scale-110",
            isActive("/crops") && `text-white scale-110 drop-shadow-md ${colors.navActive}`
          )}
        >
          <svg
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
            className="size-7"
            fill={isActive("/crops") ? "currentColor" : "none"}
            stroke="currentColor"
            strokeWidth={2}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <Link
          ...
          className={clsx(
            "transition-all duration-200 hover:text-white hover:scale-110",
            isActive("/profitability") && `text-white scale-110 drop-shadow-md ${colors.navActive}`
          )}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill={isActive("/profitability") ? "currentColor" : "none"}
            viewBox="0 0 24 24"
            strokeWidth="2"
            stroke="currentColor"
            strokeLinecap="round"
        ...
        <Link
          ...
          className={clsx(
            "transition-all duration-200 hover:text-white hover:scale-110",
            isActive("/characters") && `text-white scale-110 drop-shadow-md ${colors.navActive}`
          )}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill={isActive("/characters") ? "currentColor" : "none"}
            viewBox="0 0 24 24"
            strokeWidth="2"
            stroke="currentColor"
            strokeLinecap="round"
